...
function preload(){
  ...
  groundImage = loadImage("download (14).png");
...
function setup() {
  ...
  ground = createSprite(width/2,height-265,width,2);
  ...
  trex.setCollider("circle",0,0,23);
  trex.debug = true
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(width/2,height-105,10,40);
   //obstacle.scale=5;
